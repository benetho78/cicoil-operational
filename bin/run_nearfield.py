...
if __name__ == "__main__":
  ...
  profile_name = ''.join((output_path, PtoParam['sim_name'][0:-3],'-v_profile_', txtTime, '_', PtoParam['point']['name'], '.nc'))
  ...
  output_name = ''.join((output_path,PtoParam['sim_name'][0:-3],'-tamoc_', txtTime, '_', PtoParam['point']['name'],'_',str(release_depth.as_integer_ratio()[0]),'m'))
